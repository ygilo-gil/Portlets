			...
			<tr>
				...
				<td><fmt:formatNumber type="currency"
					...
					<c:choose>
						...
						<c:when test="${portletSessionScope.transaction.detail.paymentMethod == '4' || portletSessionScope.transaction.detail.paymentMethod == '31' || portletSessionScope.transaction.detail.paymentMethod == '32'}">
							<tr>
								<td><liferay-ui:message key="field-transaction-date"/></td>
								<td>${portletSessionScope.transaction.detail.pseDate}</td>
							</tr>
